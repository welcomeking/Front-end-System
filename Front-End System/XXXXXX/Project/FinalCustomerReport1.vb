...
Public Class FinalCustomerReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FinalCustomerReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project.FinalCustomerReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CustomerNumber() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFinalCustomerReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalCustomerReport = New FinalCustomerReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
