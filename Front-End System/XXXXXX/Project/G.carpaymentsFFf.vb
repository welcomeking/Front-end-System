...
Public Class GcarpaymentsFFf
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project.G.carpaymentsFFf.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CArID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedGcarpaymentsFFf
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GcarpaymentsFFf = New GcarpaymentsFFf()
        rpt.Site = Me.Site
        Return rpt
    End Function
