...
Public Class FinalFinReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project.FinalFinReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalFinReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalFinReport = New FinalFinReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
